...
const Footer = (props) => {
    ...
    if (isUserManager || isVoucher|| isAdmin || isAddUser || isUpdateUser || isRevenue || isProductManager || isAddProduct || isUpdateProduct || isStaffManager || isAdminProfile || isTimeLine || isAddAccessories) {
        return <FooterAdmin />
    }
    return (
        <div className='Foot'>
