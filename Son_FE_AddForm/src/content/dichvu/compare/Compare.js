        ...
        <table className="table-compare">
          ...
          <tbody className="table-compare-body">
            ...
            <tr>
              ...
              {selectedProducts.map((product) => (
                <td className="compare-product-name">{product.totalPrice}</td>
              ))}
            </tr>
            ...
            <tr>
              ...
              {selectedProducts.map((product) => (
                <td className="compare-product-name">{product.orderLevel}</td>
              ))}
            </tr>
            ...
            <tr>
              ...
              {selectedProducts.map((product) => (
                <td className="compare-product-name">{product.cage.material}</td>
              ))}
            </tr>
            ...
            <tr>
              ...
              {selectedProducts.map((product) => (
                <td className="compare-product-name">{product.cage.size}</td>
              ))}
            </tr>
            ...
            <tr>
              ...
              {selectedProducts.map((product) => (
                <td className="compare-product-name">{product.cage.price}</td>
              ))}
            </tr>
          </tbody>
        </table>
