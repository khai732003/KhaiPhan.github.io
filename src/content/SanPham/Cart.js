  ...
  const handleOrderClick = async () => {
    ...
    try {
      ...
      if (!orderId) {
        ...
        const orderResponse = await customAxios.post('http://localhost:8080/cageshop/api/order/add', {
          status: "pending",
          paymentMethod: "VNP",
      ...
      for (const item of cart) {
        await customAxios.post('http://localhost:8080/cageshop/api/order_detail/add', {
          quantity: 1,
